...
-- copy files to new instance for test restore
-- This exercise is left to the reader
-- If you have issues, see this blog: https://voiceofthedba.wordpress.com/2013/08/19/restoring-a-tde-database-on-a-new-instance/
